    ...
    return (
        <div style={{ 
            ...
            <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
                <input onChange={(e)=>setTitle(e.target.value)} type='text' placeholder='Entry post title' className='px-4 py-2 outline-none'/>
                ...
                <textarea onChange={(e)=>setTitle(e.target.value)} rows={15} cols={30} placeholder='Enter post description' className='px-4 py-2 outline-none'></textarea> 
